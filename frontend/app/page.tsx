...
export default function Home() {
  ...
  // 1. Day Selection State (defaults to Day 5 as current day)
  const currentDay = days.find((day) => day.status === 'current') ?? days[4] ?? days[0];
  const [selectedDayId, setSelectedDayId] = useState<string>(currentDay?.id || 'day-5');
